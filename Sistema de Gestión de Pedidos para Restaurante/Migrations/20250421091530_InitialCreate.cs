    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriasPlato", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriaPlatoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Platos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Platos_CategoriasPlato_CategoriaPlatoId",
                        column: x => x.CategoriaPlatoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesPedido", x => new { x.PedidoId, x.PlatoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Platos_CategoriaPlatoId",
                table: "Platos",
